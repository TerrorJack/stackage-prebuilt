...
ENV \
  ...
  LC_ALL=C.UTF-8 \
  LC_CTYPE=C.UTF-8 \
  PATH=/home/stackage/.local/bin:/home/stackage/.stack/programs/x86_64-linux/ghc-musl-8.6.5/bin:${PATH}
...
COPY --chown=stackage:stackage alpine.config.yaml /home/stackage/.stack/config.yaml
